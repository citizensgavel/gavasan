...
namespace App\Middleware\WebSocketMiddleware;
...
final class WebSocketMiddleware
{
    ...
    public function __construct(callable $connectionHandler = null, array $subProtocols = [], WebSocketOptions $webSocketOptions = null)
    {
